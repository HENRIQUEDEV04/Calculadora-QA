...
<meta name="description" content="declaration: module: CalculadoraQA, package: Junit, class: Calculadora">
...
<li><a href="class-use/Calculadora.html">Use</a></li>
...
<h1 title="Class Calculadora" class="title">Class Calculadora</h1>
</div>
...
<div class="inheritance">Junit.Calculadora</div>
</div>
<section class="class-description" id="class-description">
<hr>
<div class="type-signature"><span class="modifiers">public class </span><span class="element-name type-name-label">Calculadora</span>
...
<div class="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" class="member-name-link">Calculadora</a>()</code></div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#somar(int,int)" class="member-name-link">somar</a><wbr>(int&nbsp;a,
 int&nbsp;b)</code></div>
...
<h3>Calculadora</h3>
<div class="member-signature"><span class="modifiers">public</span>&nbsp;<span class="element-name">Calculadora</span>()</div>
</section>
</li>
</ul>
</section>
...
<ul class="member-list">
<li>
<section class="detail" id="somar(int,int)">
<h3>somar</h3>
<div class="member-signature"><span class="modifiers">public</span>&nbsp;<span class="return-type">int</span>&nbsp;<span class="element-name">somar</span><wbr><span class="parameters">(int&nbsp;a,
 int&nbsp;b)</span></div>
</section>
</li>
</ul>
